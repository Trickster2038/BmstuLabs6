...
tmin=-1; tmax=2; dt=tmax-tmin; % Интервал определения функции
...
%hold on; plot(f_pdf,Phi_f,'Color',Color0,'LineWidth',3);
...
title({'\rm Гистограмма равномерного распределения',...
...
set(get(gcf, 'CurrentAxes'), 'FontSize', 10); % Изменение шрифта
title({'\rm Случайная величина с равномерным распределением','(амплитуда сигнала)'}); % Заголовок
xlabel('Время,\it nT_д\rm, с'); % Надпись оси абсцисс
