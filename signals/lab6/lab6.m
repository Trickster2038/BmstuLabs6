...
sw_notes=[getNote(A4,t05), Z_t_cust,getNote(E4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,getNote(E4,t05), Z_t_cust,...
getNote(A4,t05), Z_t_cust,... % Ля Ми Ля Ми Ля
getNote(G4,t05), Z_t_cust,getNote(G4,t05), Z_t_cust,getNote(G4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,...
getNote(G4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,getNote(G4,t05), Z_t_cust,... % Соль х3 - Ми - Соль - Ми - Соль
getNote(A4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,getNote(E4,t05), Z_t_cust,... % Ля х3 - Ми
getNote(A4,t05), Z_t_cust,getNote(E4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,... % Ля Ми Ля
getNote(G4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,getNote(G4,t05), Z_t_cust,... % Соль х3 - Ми - Соль - Ми - Соль
getNote(A4,t05), Z_t_cust,getNote(A4,t05), Z_t_cust,getNote(B4,t05), Z_t_cust,getNote(B4,t05), Z_t_cust,...
